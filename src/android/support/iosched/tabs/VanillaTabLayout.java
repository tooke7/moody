...
//		setSelectedIndicatorColors(context.getResources().getColor(com.jacobobryant.moody.com.jacobobryant.moody.vanilla.R.color.tabs_active_indicator));
	...
	protected TextView createDefaultTabView(Context context) {
		...
		//view.setTextColor(getResources().getColorStateList(com.jacobobryant.moody.com.jacobobryant.moody.vanilla.R.color//.tab_text_selector));
		//view.setBackgroundResource(com.jacobobryant.moody.com.jacobobryant.moody.vanilla.R.drawable.unbound_ripple_light);
		view.setMaxLines(1);
