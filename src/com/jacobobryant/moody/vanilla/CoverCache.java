...
public class CoverCache {
	...
	/**
	 * Use com.jacobobryant.moody.vanilla musics cover load mechanism
	 */
	public static final int COVER_MODE_VANILLA = 0x2;
	/**
	 * Use com.jacobobryant.moody.vanilla musics SHADOW cover load mechanism
	 */
		...
		public Bitmap createBitmap(Song song, long maxPxCount) {
			...
			try {
				...
				if (inputStream == null && (CoverCache.mCoverLoadMode & CoverCache.COVER_MODE_SHADOW) != 0) {
					String shadowPath = "/sdcard/Music/.com.jacobobryant.moody.vanilla/"+(song.artist.replaceAll("/", "_"))+"/"+(song.album.replaceAll("/", "_"))+".jpg";
