...
public class MirrorLinkMediaBrowserService extends MediaBrowserService
	...
	private static final String CUSTOM_ACTION_REPEAT = "ch.blinkenlights.android.com.jacobobryant.moody.vanilla.REPEAT";
	// Action to change the repeat mode
	private static final String CUSTOM_ACTION_SHUFFLE = "ch.blinkenlights.android.com.jacobobryant.moody.vanilla.SHUFFLE";
		...
		mMediaRoot.add(new MediaBrowser.MediaItem(
				new MediaDescription.Builder()
					...
					.setIconUri(Uri.parse("android.resource://" +
							"ch.blinkenlights.android.com.jacobobryant.moody.vanilla/drawable/ic_menu_music_library"))
